...
import { suggestedQuestions } from "../initial-analysis/data";
    ...
    setMessages([
      {
        id: "welcome",
        type: "agent",
        content: `I'm analyzing the healthcare compliance patterns for ${signalData.title}. What would you like to know?`
      }
    ]);
  }, [signalData.title]);
